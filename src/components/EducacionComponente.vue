...
const educacion = ref([
  {fecha: '2024', title: 'Técnicatura Universitaria en Programacion en proceso', descripcion: 'Incumbencias Profesionales: Operación y programación de computadoras, desarrollo de programas en distintos lenguajes, análisis y control de sistemas informáticos.', enlace:'https://www.youtube.com/'},
  {fecha: '2023', title: 'Maestro Mayor de Obras', descripcion: 'Estudie en la Escuela Enet Ejercito de los años con 1 año de pasantias por toda la ciudad de San Rafael en numerables Obras.', enlace:'http:www.direccion.com'},
...
body {
  ...
  --bgColor: rgb(85, 75, 75); /* Variable para el color de fondo */
