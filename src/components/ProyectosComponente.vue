<script setup>
import proyecto1 from '/src/assets/tinder.jpg';
import proyecto2 from '/src/assets/mcdonalds.jpg';
import proyecto3 from '/src/assets/blog.png';
import proyecto4 from '/src/assets/hospital.jpg';
...
misProyectos.value = ([
    //esto es un array de objetos que contiene información sobre los proyectos
    {
        ...
        descripcion: "Creé una aplicación móvil online para mediante un sistema de likes dos personas puedan quedar.",
    ...
    },
    {
        id: 2,
        src: proyecto2,
        titulo: "Página para empresa de comida (2022)",
        descripcion: "Diseñé y desarrollé una plataforma con una interfaz de menu para pedir a domicilio",
        projectoLink: "https://www.google.com.ar",
        githubLink: "https://github.com/usuario/proyecto"
    },
    {
    ...
    },
    {
        id: 4,
        src: proyecto4,
        titulo: "Aplicación de Reservas para Turnos medicos (2023)",
        descripcion: "Creé una aplicación móvil con Flutter que permite a los usuarios reservar turnos en distintas ramas de un hospital",
        projectoLink: "https://www.google.com.ar",
        githubLink: "https://github.com/usuario/proyecto"
    },
])
