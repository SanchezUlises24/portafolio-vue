...
const experiencias = ref([
    { id: 1, src: icono1, parrafo: 'Fui un equipo de 3 desarrolladores en la creación de una plataforma de comercio electrónico.' },
    { id: 2, src: icono2, parrafo: 'Desarrollé aplicaciones web utilizando Node.js, React y MongoDB.' },
    { id: 3, src: icono3, parrafo: 'Implementé soluciones de autenticación y autorización, mejorando la seguridad del sitio web..' },
    { id: 4, src: icono4, parrafo: 'Colaboré con diseñadores de UX/UI para crear interfaces de usuario atractivas y fáciles de usar, .' },
    { id: 5, src: icono5, parrafo: 'Automaticé procesos de despliegue continuo utilizando Jenkins y Docker..' },
]);
</script>
...
.card {
    ...
    padding: 2rem;
    background-color: rgb(109, 146, 177);
    border-radius: 15px;
}

.titulo {
    font-size: 1.5rem;
    color: rgb(101, 151, 68);
}
